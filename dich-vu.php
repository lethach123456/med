...
front_editor_page_maybe_redirect('dich-vu');
$pdo = db();
...
// Fetch services from Vietnamese services category.
$services = [];
try {
  $st = $pdo->prepare(
...
<html lang="vi">
  <head>
    ...
    <?php
      $seo = front_editor_page_seo('dich-vu', [
        'title' => 'Top Dental Clinic • Dịch vụ nha khoa',
        'description' => 'Khám phá các dịch vụ nổi bật tại Top Dental Clinic, từ răng sứ thẩm mỹ, implant đến chăm sóc nụ cười chuyên sâu tại Đà Nẵng.',
      ]);
    ...
    <link rel="canonical" href="<?php echo htmlspecialchars(site_absolute_url((string) ($seo['canonical_path'] ?? '/dich-vu')), ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <body>
    ...
    <section class="hero">
      ...
      <div class="container hero-inner">
        <div class="hero-grid">
          <div class="hero-copy">
            <div class="hero-kicker"><span class="dot" aria-hidden="true"></span> Dịch vụ nha khoa</div>
            <h1>Dịch vụ chuyên nghiệp tại Top Dental Clinic</h1>
            <p>Chúng tôi cung cấp đầy đủ các dịch vụ nha khoa chất lượng cao, đặc biệt là dịch vụ răng sứ thẩm mỹ hàng đầu.</p>
            <div class="hero-actions">
              <a class="btn btn-primary" href="/lien-he.php"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Đặt lịch tư vấn</a>
              <a class="btn btn-ghost" href="#dich-vu"><i class="fa-solid fa-teeth" aria-hidden="true"></i> Xem tất cả dịch vụ</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="about-grid">
          ...
          <div class="about-content">
            <h2>Về Top Dental Clinic</h2>
            <p>Với hơn 15 năm kinh nghiệm trong ngành nha khoa, DentaElite đã và đang là địa chỉ tin cậy của hàng ngàn khách hàng. Chúng tôi không ngừng nâng cao chất lượng dịch vụ và đầu tư trang thiết bị hiện đại để mang đến trải nghiệm tốt nhất cho bạn.</p>
            <p>Đặc biệt, dịch vụ răng sứ thẩm mỹ của chúng tôi luôn được khách hàng đánh giá cao về chất lượng và thẩm mỹ. Hãy đến với DentaElite để có được nụ cười như mong muốn!</p>
            ...
            <a class="btn btn-primary" href="/lien-he.php" style="margin-top: 16px;"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Đặt lịch khám ngay</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section" id="dich-vu">
      <div class="container">
        ...
        <p class="section-lead">Tất cả các dịch vụ nha khoa được cung cấp tại DentaElite, với sự chăm sóc tận tâm từ đội ngũ bác sĩ chuyên gia.</p>
            ...
            <div class="admin-hover-wrap" style="height: 100%;">
              <article class="card" style="height: 100%;">
                ...
                <div class="body">
                  ...
                  <div class="excerpt">Dịch vụ răng sứ cao cấp, giúp bạn có nụ cười trắng sáng và tự tin.</div>
                  <div class="actions">
                    <a class="btn btn-primary" href="/lien-he.php"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Đặt lịch</a>
                  </div>
                </div>
            ...
            <div class="admin-hover-wrap" style="height: 100%;">
              <article class="card" style="height: 100%;">
                ...
                <div class="body">
                  ...
                  <div class="excerpt">Giải pháp thay thế răng mất hiệu quả, mang lại cảm giác như răng thật.</div>
                  <div class="actions">
                    <a class="btn btn-primary" href="/lien-he.php"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Đặt lịch</a>
                  </div>
                </div>
            ...
            <div class="admin-hover-wrap" style="height: 100%;">
              <article class="card" style="height: 100%;">
                ...
                <div class="body">
                  ...
                  <div class="excerpt">Điều trị các vấn đề về khớp cắn, giúp răng đều đẹp.</div>
                  <div class="actions">
                    <a class="btn btn-primary" href="/lien-he.php"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Đặt lịch</a>
                  </div>
                </div>
    ...
    <section class="section">
      <div class="container">
        ...
        <p class="section-lead">Mỗi dịch vụ đều được thiết kế xoay quanh tính an toàn, sự minh bạch và hiệu quả thẩm mỹ lâu dài để khách hàng yên tâm từ lúc tư vấn đến sau điều trị.</p>
        <div class="feature-grid">
          <article class="feature-card">
            <i class="fa-solid fa-user-doctor" aria-hidden="true"></i>
            <h3>Đội ngũ chuyên môn rõ ràng</h3>
            <p>Mỗi nhóm dịch vụ được theo sát bởi bác sĩ có kinh nghiệm thực chiến, giúp chẩn đoán sát tình trạng và xây dựng hướng điều trị phù hợp thay vì áp dụng một công thức chung.</p>
          </article>
          <article class="feature-card">
            <i class="fa-solid fa-microscope" aria-hidden="true"></i>
            <h3>Thiết bị hỗ trợ hiện đại</h3>
            <p>Hình ảnh, dữ liệu và các bước thăm khám được trình bày trực quan để khách hàng hiểu rõ vấn đề răng miệng, thời gian điều trị và chi phí trước khi quyết định.</p>
          </article>
          <article class="feature-card">
            <i class="fa-solid fa-heart-circle-check" aria-hidden="true"></i>
            <h3>Theo dõi sau điều trị</h3>
            <p>Không chỉ hoàn tất dịch vụ, chúng tôi còn duy trì lịch tái khám, nhắc hẹn và hướng dẫn chăm sóc cụ thể để kết quả ổn định, bền đẹp hơn theo thời gian.</p>
          </article>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <h2>Quy trình tiếp nhận và điều trị</h2>
        <p class="section-lead">Top Dental Clinic xây dựng quy trình rõ từng bước để bạn biết mình đang ở giai đoạn nào, cần chuẩn bị gì và kết quả dự kiến ra sao sau mỗi mốc điều trị.</p>
        <div class="process-grid">
          <article class="process-card">
            <i class="fa-solid fa-comments" aria-hidden="true"></i>
            <h3>1. Tư vấn ban đầu</h3>
            <p>Tiếp nhận nhu cầu, lắng nghe mong muốn thẩm mỹ và ghi nhận tiền sử điều trị để xác định hướng thăm khám phù hợp ngay từ đầu.</p>
          </article>
          <article class="process-card">
            <i class="fa-solid fa-camera-retro" aria-hidden="true"></i>
            <h3>2. Chụp phim, kiểm tra</h3>
            <p>Đánh giá tình trạng răng miệng bằng hình ảnh và chỉ số thực tế, từ đó xây dựng kế hoạch điều trị có căn cứ rõ ràng.</p>
          </article>
          <article class="process-card">
            <i class="fa-solid fa-file-medical" aria-hidden="true"></i>
            <h3>3. Lên phác đồ</h3>
            <p>Bác sĩ giải thích phương án đề xuất, mốc thời gian, vật liệu sử dụng và các lưu ý cần chuẩn bị trước khi bắt đầu điều trị.</p>
          </article>
          <article class="process-card">
            <i class="fa-solid fa-hand-holding-medical" aria-hidden="true"></i>
            <h3>4. Theo dõi định kỳ</h3>
            <p>Sau dịch vụ, khách hàng được hẹn kiểm tra và hướng dẫn chăm sóc chi tiết để duy trì kết quả ổn định, giảm nguy cơ tái phát.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="timeline">
          <div class="timeline-panel">
            <h2 style="text-align:left; margin-bottom:8px;">Hành trình dịch vụ được cá nhân hóa</h2>
            <p class="section-lead" style="text-align:left; margin:0; max-width:none;">Không phải khách hàng nào cũng cần cùng một lộ trình. Chúng tôi điều chỉnh kế hoạch theo tình trạng răng, mục tiêu thẩm mỹ, quỹ thời gian và mức độ ưu tiên của từng người.</p>
            <div class="timeline-list">
              <div class="timeline-item">
                <div class="timeline-step">01</div>
                <div class="timeline-copy">
                  <strong>Khảo sát nhu cầu thực tế</strong>
                  <span>Bạn được tư vấn dựa trên vấn đề đang gặp phải, thay vì chỉ chọn dịch vụ theo tên gọi hay xu hướng chung.</span>
                </div>
              </div>
              <div class="timeline-item">
                <div class="timeline-step">02</div>
                <div class="timeline-copy">
                  <strong>Ưu tiên giải pháp phù hợp nhất</strong>
                  <span>Mỗi phương án được cân nhắc giữa thẩm mỹ, chức năng ăn nhai, độ bền, chi phí và thời gian điều trị.</span>
                </div>
              </div>
              <div class="timeline-item">
                <div class="timeline-step">03</div>
                <div class="timeline-copy">
                  <strong>Kiểm soát trải nghiệm trong suốt quá trình</strong>
                  <span>Đội ngũ phòng khám theo dõi sát tiến độ, cảm giác của khách hàng và điều chỉnh lịch trình khi cần để hành trình điều trị nhẹ nhàng hơn.</span>
                </div>
              </div>
            </div>
          </div>
          <aside class="quote-panel">
            <blockquote>"Một dịch vụ tốt không chỉ đẹp ở kết quả sau cùng, mà còn phải rõ ràng, an tâm và dễ theo dõi trong từng bước điều trị."</blockquote>
            <p>Đó là lý do chúng tôi đầu tư đồng đều vào tư vấn, dữ liệu, tay nghề và hậu chăm sóc thay vì chỉ tập trung vào một điểm chạm duy nhất.</p>
            <a class="btn btn-primary" href="/lien-he.php"><i class="fa-solid fa-calendar-check" aria-hidden="true"></i> Nhận lộ trình tư vấn</a>
          </aside>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        ...
        <p class="section-lead">Một số băn khoăn phổ biến trước khi khách hàng bắt đầu dịch vụ tại phòng khám, đặc biệt ở nhóm điều trị thẩm mỹ và phục hình.</p>
        <div class="faq-grid">
          <article class="faq-card">
            <i class="fa-solid fa-circle-question" aria-hidden="true"></i>
            <h3>Nên khám trước hay đặt thẳng dịch vụ?</h3>
            <p>Bạn nên khám và tư vấn trước để bác sĩ đánh giá tình trạng thực tế. Việc này giúp chọn đúng phương án, tránh làm dịch vụ chưa thật sự phù hợp.</p>
          </article>
          <article class="faq-card">
            <i class="fa-solid fa-clock" aria-hidden="true"></i>
            <h3>Thời gian điều trị có kéo dài không?</h3>
            <p>Tùy từng dịch vụ, có thể hoàn tất nhanh hoặc cần nhiều mốc hẹn. Ngay từ đầu, bác sĩ sẽ giải thích khung thời gian dự kiến để bạn dễ sắp xếp.</p>
          </article>
          <article class="faq-card">
            <i class="fa-solid fa-shield-heart" aria-hidden="true"></i>
            <h3>Làm sao để yên tâm về độ an toàn?</h3>
            <p>Phòng khám kiểm soát quy trình vô khuẩn, chỉ định điều trị và hậu chăm sóc chặt chẽ. Mọi bước đều được trao đổi rõ trước khi thực hiện.</p>
          </article>
          <article class="faq-card">
            <i class="fa-solid fa-sparkles" aria-hidden="true"></i>
            <h3>Có được tư vấn theo nhu cầu thẩm mỹ riêng không?</h3>
            <p>Có. Chúng tôi luôn ưu tiên thiết kế nụ cười và giải pháp điều trị dựa trên gương mặt, tình trạng răng và mong muốn cá nhân của từng khách hàng.</p>
          </article>
        </div>
      </div>
    </section>

    <?php if (function_exists('front_editor_render')) { front_editor_render('dich-vu'); } ?>
