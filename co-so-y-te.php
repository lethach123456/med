...
<head>
  ...
  <style id="directory-hero-polish">
    ...
    .directory-search .filter-submit i { font-size: 19px; line-height: 1; }
    ...
    @media (max-width: 560px) {
      ...
      .directory-search .filter-submit { width: 48px; min-width: 48px; height: 48px; }
