...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($name === '' || $phone === '' || $message === '') {
    $error = 'Please enter your full name, phone number, and message.';
  } else {
    $sent = true;
  }
}
...
front_editor_page_maybe_redirect('contact-en');
...
<html lang="en">
  <head>
    ...
    <?php
      $seo = front_editor_page_seo('contact-en', [
        'title' => 'Top Dental Clinic • Contact',
        'description' => 'Contact Top Dental Clinic to book a consultation, ask about services, and connect quickly with our patient care team.',
      ]);
    ...
    <link rel="canonical" href="<?php echo htmlspecialchars(site_absolute_url((string) ($seo['canonical_path'] ?? '/contact-us')), ENT_QUOTES, 'UTF-8'); ?>">
  ...
  <body>
    ...
    <section class="hero">
      ...
      <div class="container hero-inner">
        <div class="hero-copy">
          <h1>Contact Top Dental Clinic</h1>
          <p>Request a complimentary consultation for dental care, especially porcelain smile design and restorative services. Our team will guide you with clarity and care.</p>
          <div class="hero-actions">
            <a class="btn btn-primary" href="tel:<?php echo htmlspecialchars(str_replace(' ', '', $hotline), ENT_QUOTES, 'UTF-8'); ?>"><i class="fa-solid fa-phone" aria-hidden="true"></i> Call now</a>
          </div>
        </div>
      </div>
    ...
    <section class="section">
      <div class="container">
        <div class="grid">
          <div class="card">
            ...
            <div class="bd">
              ...
              <div class="contact-item">
                ...
                <div class="contact-text">
                  <b>Opening hours</b>
                  <span>08:00-18:00 (Monday-Saturday)</span>
                </div>
              </div>
              <div class="map">
          ...
          <div class="card">
            <div class="hd">Send us a request</div>
            <div class="bd">
              <?php if ($sent): ?>
                <div class="alert ok">Your request has been received. Top Dental Clinic will contact you as soon as possible.</div>
              <?php elseif ($error !== ''): ?>
              ...
              <form class="form" method="post" action="/contact-us">
                <div class="row">
                  <div class="field">
                    ...
                    <input name="name" value="<?php echo htmlspecialchars((string)($_POST['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="Enter your full name">
                  </div>
                  <div class="field">
                    <label>Phone number</label>
                    <input name="phone" value="<?php echo htmlspecialchars((string)($_POST['phone'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="Enter your phone number">
                  </div>
                </div>
                <div class="field">
                  <label>Email (optional)</label>
                  <input name="email" value="<?php echo htmlspecialchars((string)($_POST['email'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>" placeholder="Enter your email">
                </div>
                <div class="field">
                  <label>Message</label>
                  <textarea name="message" placeholder="Tell us about your needs, concerns, or the service you are interested in..."><?php echo htmlspecialchars((string)($_POST['message'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
    ...
    <?php if (function_exists('front_editor_render')) { front_editor_render('contact-en'); } ?>
